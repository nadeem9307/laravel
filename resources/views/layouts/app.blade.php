...
<head>
    ...
    <title>{{ config('app.name', 'Cookforme Dashboard') }}</title>
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('bpublic/lack') }}/img/apple-icon.png">
    ...
    <link href="{{ asset('public/black') }}/css/bootstrap-datepicker.css" rel="stylesheet" />
    @yield('page_css')
    <script>
...
<body class="{{ $class ?? '' }}">
    ...
    <script src="{{ asset('public/black') }}/demo/bootstrap-datepicker.js"></script>
    ...
    <script src="https://demos.creative-tim.com/marketplace/black-dashboard-pro/assets/js/plugins/jasny-bootstrap.min.js"></script>
    <!--  Google Maps Plugin    -->
