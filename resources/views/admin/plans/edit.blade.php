                        ...
                        <form method="post" action="{{ route('plans.update',$plan) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('plan_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="plan_name" id="input-name" class="form-control form-control-alternative{{ $errors->has('plan_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Plan Name') }}" value="{{ old('plan_name',$plan->plan_name) }}" required autofocus>
                                    @include('alerts.feedback', ['field' => 'plan_name'])
                                </div>
                                <div class="form-group{{ $errors->has('plan_description') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-description">{{ __('Description') }}</label>
                                    <input type="text" name="plan_description" id="input-description" class="form-control form-control-alternative{{ $errors->has('plan_description') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}" value="{{ old('plan_description',$plan->plan_description) }}" required>
                                 ...
                                 <div class="form-group{{ $errors->has('plan_meal_limit') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="plan_meal_limit" id="plan_meal_limit" class="form-control form-control-alternative{{ $errors->has(' plan_meal_limit') ? ' is-invalid' : '' }}" placeholder="{{ __('Plan Meal Limit') }}" value="{{ old('plan_meal_limit',$plan->plan_meal_limit) }}" required>
                                  ...
                                  <div class="form-group{{ $errors->has('plan_meal_type') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control select_custom" name="plan_meal_type" title="Single Select" tabindex="-98">
                                        ...
                                        @if($plan->plan_meal_type == 'weekly') 
                                            <option value="{{ __('weekly') }}" selected="selected">{{ __('Weekly') }}</option>
                                         @endif
                                          @if($plan->plan_meal_type == 'monthly')
                                            <option value="{{ __('monthly') }}" selected="selected">{{ __('Monthly') }}</option>
                                        @endif
                                 ...
                                 <div class="form-group{{ $errors->has('plan_per_meal_price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="plan_per_meal_price" id="plan_per_meal_price" class="form-control form-control-alternative{{ $errors->has('  plan_per_meal_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Plan Per Meal Price') }}" value="{{ old('  plan_per_meal_price',$plan->plan_per_meal_price) }}" required>
                                    @include('alerts.feedback', ['field' => ' plan_per_meal_price'])
                                </div>  
                                 <div class="form-group{{ $errors->has('plan_price') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-menu-size">{{ __('Plan Per Meal Price') }}</label>
                                    <input type="text" name="plan_price" id="plan_price" class="form-control form-control-alternative{{ $errors->has('  plan_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Plan Per Meal Price') }}" value="{{ old('  plan_price',$plan->plan_price) }}" required>
