        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('addcoupon.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('coupon_code') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="coupon_code" id="coupon_code" class="form-control form-control-alternative{{ $errors->has('coupon_code') ? ' is-invalid' : '' }}" placeholder="{{ __('Coupon Code') }}" value="{{ old('coupon_code') }}" size="15" maxlength="15" 
                                 ...
                                 <div class="form-group{{ $errors->has('coupon_percent') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">{{ __('Coupon Percentage') }}</label>
                                     <input type="text" name="coupon_percent" id="input-name" class="form-control form-control-alternative{{ $errors->has('coupon_percent') ? ' is-invalid' : '' }}" placeholder="{{ __('ex. 15') }}" value="{{ old('coupon_percent') }}"  required autofocus>
                                 ...
                                 <div class="form-group{{ $errors->has('coupon_end_date') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">{{ __('Coupon End Date') }}</label>
                                     <input type="text" name="coupon_end_date" id="input-name" class="datepicker form-control form-control-alternative{{ $errors->has('coupon_end_date') ? ' is-invalid' : '' }}" placeholder="{{ __('dd/mm/yyyy') }}" value="{{ old('coupon_end_date') }}" required autofocus>
